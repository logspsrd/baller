...
const ProgramPage = () => {
    ...
    return(
        <>
            <div className="h-screen w-full rounded-[50px]">
                <div className="h-full rounded-3xl flex items-center justify-center gap-16">
                    ...
                    <div className="h-[800px] w-[650px] bg-[url(./src/assets/ball-on-bench.jpg)] bg-cover bg-center rounded-3xl flex flex-col items-center justify-center">
                        ...
                        <button className="h-28 w-28 bg-white relative left-[250px] top-[200px] rounded-full hover:scale-105 hover:bg-[hsl(0,_0%,95%)] transition-all duration-300 cursor-pointer group">
