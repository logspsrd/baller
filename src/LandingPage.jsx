        ...
        <>
            <div className="bg-[url('./assets/ball-in-hand.jpg')] bg-cover bg-center h-screen w-full relative">
                <header className="h-24 w-full flex border-b-1 border-zinc-300">
                    <h2 className="h-24 w-40 flex items-center justify-center text-3xl font-equip text-white font-equip">baller.</h2>
                ...
                <div className="h-[250px] w-[600px] absolute left-[200px] top-[400px] flex">
                    <h2 className="text-white text-5xl font-equip">Become your best self through sports — create friends competition and challenges for yourself.</h2>
                </div>
            </div>
        </>
    )
