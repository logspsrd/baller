...
const CommunityPage = () => {
    ...
    return(
        <>
            {openJoinModal && <JoinModal onClose={handleCloseModal} />}
            <div className="h-screen w-full bg-[hsl(0,_0%,95%)] flex md:flex-row items-center justify-center relative">
                <div className="h-[800px] max-w-[95%] md:max-w-[80%] lg:max-w-[1600px] mx-auto rounded-[50px]">
                    <div className="h-[350px] w-[450px] flex flex-col absolute top-40 left-24">
                        ...
                        <div className="h-[125px] w-[475px] flex flex-col overflow-hidden relative">
                            ...
                            <div className="absolute bottom-0 left-0 w-full h-4 bg-gradient-to-t from-[hsl(0,_0%,95%)] to-transparent pointer-events-none" />
                        </div>
                    </div>
                    ...
                    <div className="h-[600px] w-[900px] bg-white absolute top-24 left-[650px] rounded-4xl flex items-center justify-center gap-16 shadow-xl">
                        <div className="h-[450px] w-[400px] flex flex-col">
                            ...
                            <h2 className="h-[75px] w-[350px] text-[32px] font-semibold leading-tight mb-16 pt-16">Become a member to access all communities</h2>
                        ...
                        <div className="h-[500px] w-[300px] bg-[url('./src/assets/pickle-ball.jpg')] bg-cover bg-center rounded-4xl">
                            <div className="h-full w-full bg-gradient-to-t from-black/80 to-transparent rounded-4xl"></div>
                            <div className="h-8 w-48 bg-white/20 backdrop-blur-md absolute top-[500px] left-[625px] rounded-[15px] flex items-center pl-1 gap-3">
                                <box-icon name='purchase-tag-alt' color='black' className="h-6 w-6 p-0.5 flex items-center justify-center bg-white rounded-full"></box-icon>
                                <h2 className="text-white text-[14px]">20% off first month</h2>
                            </div>
                        </div>
                    </div>
                </div>
